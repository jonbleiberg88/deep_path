...
from tensorflow.keras_applications.resnet import ResNet50V2
...
class TransferCNN:
    def __init__(self, input_shape=constants.INPUT_SHAPE, base_model=ResNet50V2,layer_sizes=constants.LAYER_SIZES,
