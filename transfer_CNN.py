...
class TransferCNN:
    def __init__(self, input_shape=(256,256,3), base_model=InceptionV3,layer_sizes=[256],
        n_classes=2, use_bn=True, use_dropout=False,
        optimizer=SGD(lr=0.2, decay=1e-6, momentum=0.9,nesterov=True), metrics=['accuracy']):
